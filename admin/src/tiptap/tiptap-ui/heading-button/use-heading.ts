...
// --- Icons ---
import { HeadingOneIcon } from "@/tiptap/tiptap-icons/heading-one-icon"
import { HeadingTwoIcon } from "@/tiptap/tiptap-icons/heading-two-icon"
import { HeadingThreeIcon } from "@/tiptap/tiptap-icons/heading-three-icon"
import { HeadingFourIcon } from "@/tiptap/tiptap-icons/heading-four-icon"
import { HeadingFiveIcon } from "@/tiptap/tiptap-icons/heading-five-icon"
import { HeadingSixIcon } from "@/tiptap/tiptap-icons/heading-six-icon"
 ...
 *     onToggled: (isActive) => console.info('Heading toggled:', isActive)
 *   })
 *
 *   if (!isVisible) return null
 *
