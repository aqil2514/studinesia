...
// --- Icons ---
import { BoldIcon } from "@/tiptap/tiptap-icons/bold-icon"
import { Code2Icon } from "@/tiptap/tiptap-icons/code2-icon"
import { ItalicIcon } from "@/tiptap/tiptap-icons/italic-icon"
import { StrikeIcon } from "@/tiptap/tiptap-icons/strike-icon"
import { SubscriptIcon } from "@/tiptap/tiptap-icons/subscript-icon"
import { SuperscriptIcon } from "@/tiptap/tiptap-icons/superscript-icon"
import { UnderlineIcon } from "@/tiptap/tiptap-icons/underline-icon"
 ...
 *     onToggled: () => console.info('Mark toggled!')
 *   })
 *
 *   if (!isVisible) return null
 *
